    ...
    $result = $con->query($SQL);	
				foreach ($result as $r) {
                    ...
                    <div class="col-xl-8 col-lg-7"> <iframe id="pdf-js-viewer" src="dashboard/note-pdf/<?php echo $r['note']; ?>" title="webviewer" frameborder="0" width="500" height="600"></iframe></div>
					 <div class="col-xl-4 col-lg-5">
                        <div class="featured-text text-center text-lg-left">
						 <p class="text-white"> <?php echo $r['uni_name']; ?> University <br><?php echo $r['depart_name']; ?> Department<br><?php echo $r['subject_name']; ?> Subject<br> <?php echo $r['sem_name']; ?> Semester<br>By:<?php echo $r['notemaker_name']; ?></p><br>
