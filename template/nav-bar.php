<!-- nav-bar.php -->
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="index.php#page-top">Needy Engineer</a>
			...
			<li class="nav-item" style="text-transform:capitalize;"><a href="dashboard/profile.php" class="nav-link">Profile</a></li><!--<center><i class="fa fa-user" aria-hidden="true"></i></center>-->
	        <?php } ?>
