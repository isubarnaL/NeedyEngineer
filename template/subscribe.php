<!--- subscribe --->
  ...
  <strong>wow thanks!</strong> You have already subscribed to us.
  ...
  <?php
		...
		?>
                        ...
                        <form class="form-inline d-flex" action="#signup" method="POST" enctype="multipart/form-data" >
                            <input class="form-control flex-fill mr-0 mr-sm-2 mb-3 mb-sm-0" name="subsemail" type="email" placeholder="Enter email address..." />
